...
import jdd.grammar.ArithmeticExpression;
import jdd.grammar.ArrayCreateExpression;
import jdd.grammar.ArrayLengthExpression;
import jdd.grammar.ArrayOperandExpression;
import jdd.grammar.AssignmentStatement;
import jdd.grammar.BitwiseExpression;
import jdd.grammar.BreakStatement;
import jdd.grammar.ComparisonExpression;
import jdd.grammar.ConditionExpression;
import jdd.grammar.ContinueStatement;
import jdd.grammar.Expression;
import jdd.grammar.ExpressionList;
import jdd.grammar.IfElseStatement;
import jdd.grammar.IncDecExpression;
import jdd.grammar.LocalVariableIncStatement;
import jdd.grammar.LoopStatement;
import jdd.grammar.MethodBody;
import jdd.grammar.MethodInvocationExpression;
import jdd.grammar.MethodInvocationStatement;
import jdd.grammar.ObjectCreateExpression;
import jdd.grammar.OperandExpression;
import jdd.grammar.ReadExpression;
import jdd.grammar.ReturnStatement;
import jdd.grammar.StatementList;
import jdd.grammar.TernaryOperatorExpression;
import jdd.grammar.TypecastExpression;
import jdd.grammar.UnaryExpression;
import jdd.grammar.WriteArrayStatement;
import jdd.grammar.WriteFieldStatement;
